...
def enqueue_job(job_type: str, title: str, payload: dict[str, Any], task: JobCallable, progress_total: int = 0) -> int:
    job_id = create_job(job_type=job_type, title=title, payload=payload, progress_total=progress_total)
