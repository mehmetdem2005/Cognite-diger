-- Delivery 1: Localization and language profile model

-- Profiles: user language preferences
...
-- Highlights: language field for flow filtering
ALTER TABLE IF EXISTS public.highlights
  ADD COLUMN IF NOT EXISTS language TEXT DEFAULT 'tr';

-- Vocabulary: track source/target language pair
...
-- App settings defaults for localization
